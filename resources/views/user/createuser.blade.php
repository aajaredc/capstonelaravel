...
@section('content')
  ...
  <div class="card">
      ...
      @endif
      <form class="was-validated" method="post" action="{{ route('storeuser') }}">
        @csrf
				<div class="row">
					<div class="col-12 col-md-2 mb-3">
						<input name="firstname" type="text" class="form-control" placeholder="First Name" value="{{ old('firstname') }}" required autocomplete="firstname" autofocus>
						<div class="valid-feedback">Valid first name</div>
						<div class="invalid-feedback">Invalid first name</div>
					</div>
          <div class="col-12 col-md-2 mb-3">
						<input name="lastname" type="text" class="form-control" placeholder="Last Name" value="{{ old('lastname') }}" required autocomplete="lastname" autofocus>
        ...
        <div class="row">
          ...
          <div class="col-12 col-md-3 mb-3">
            <input name="email" type="text" class="form-control" placeholder="Email" value="{{ old('email') }}" required autocomplete="email" autofocus>
          ...
          <div class="col-12 col-md-3 mb-3">
            <select name="type" class="form-control" required>
              ...
              @foreach ($types as $type)
                {{-- @if ($type->id == $user->user_type_id) selected @endif> --}}
